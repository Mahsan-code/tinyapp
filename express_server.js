...
app.get('/urls', (req, res) => {
  ...
  if (users[userId]) {
    ...
    const err = "Please register or login to access this page!";
...
app.post("/urls", (req, res) => {
  ...
  const userId = req.session['user_id'];
  if (!users[userId]) {
    const err = "Please register or login to create new URL!";
    let templateVars = {
      err,
      user: null
    };
...
app.put('/urls/:shortURL', (req, res)=>{
  ...
  const userId = req.session['user_id'];
  if (!users[userId]) {
    const err = "Please register or login to edit URL!";
    let templateVars = {
      err,
      user: null
    };
...
app.delete('/urls/:shortURL', (req, res)=>{
  ...
  const shortURL = req.params.shortURL;
  if (!users[userId]) {
    const err = "Please register or login to delete URL!";
    let templateVars = {
      err,
      user: null
    };
